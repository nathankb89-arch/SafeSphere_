...
const PROFESSIONALS = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=700&q=85',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1531384441138-2736e62e0919?auto=format&fit=crop&w=700&q=85',
    imagePosition: 'object-center',
    accent: 'status-red',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=700&q=85',
    imagePosition: 'object-center',
    accent: 'status-green',
  },
  {
    ...
    <main className="page-shell">
      ...
      <section className="container pb-16">
        <div className="cta-banner">
          <div>
            <p className="eyebrow eyebrow-cta">Learn first</p>
            <h2 className="section-title small cta-title">Build confidence before an emergency happens.</h2>
          </div>
